...
class SigCaptDialog {
    ...
    async open(sigObj, who, why, where, extraData, integrityType, documentHash, osInfo, digitizerInfo, nicInfo) {
        ...
        // if (isEvaluation) {
        //     this.sigObj.isEvaluation = isEvaluation;
        // } else {
            this.sigObj.isEvaluation = "";
        // }
    ...
    createWindow(width, height) {
        ...
        layoutWrapper.style.opacity = "0.1";
    ...
    createScreenImage(useColor) {
        ...
        if (this.sigObj.isEvaluation) {
            this.drawEvaluationString("", ctx, this.canvas.width, this.canvas.height - buttonsTop, useColor);
        }
