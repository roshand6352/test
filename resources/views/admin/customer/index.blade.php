        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h5 class="card-title mb-0 flex-grow-1">Customers List</h5>
...
@section('custom-script')
    <script>
        let datatable_url = '/get-customer-list'
        let redirect_url = '/customer'
        let form_url = '/customer'
        const sweetalert_delete_title = 'Delete Customer ?'
