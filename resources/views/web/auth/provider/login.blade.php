...
<head>
    ...
    <title>GreatJob - Provider Login</title>
                ...
                <div class="pt-4 mt-3 mb-3">
                    ...
                    <form id="msform">
                        ...
                        <fieldset>
                            ...
                            <p>Welcome back, Login to your Greatjob Service Provider Dashboard now</p>
                            <div class="form-card">
                                ...
                                <button type="submit" class="next action-button btn btn-primary"
                                >Continue</button>
                                ...
                                <div class="login-links">
                                    ...
                                    <p>Don’t have a Provider account? <a href="{{route('provider-signup')}}">Provider
                                            Registeration</a></p>
                                    <p>Are you a Greatjob Customer? <a href="{{route('customer-login')}}">Customer Login</a></p>
                                </div>
                        </fieldset>
